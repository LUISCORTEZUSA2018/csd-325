# Luis Cortez
# Date: June 13, 2026
# Assignment: Module 2.2 – Documented Debugging + Flowchart
# Purpose:
# This program asks the user for the number of bottles of beer
# and displays a countdown using a function until reaching 0.
# A breakpoint is added to demonstrate Python debugging.

# Import Python debugger module.
import pdb
...
def main():
    ...
    bottles = int(
        input(
            "Enter number of bottles of beer on the wall: "
        )
    )

    # Breakpoint:
    # Pause execution here to inspect variables
    # and move through the program step by step.
    pdb.set_trace()
