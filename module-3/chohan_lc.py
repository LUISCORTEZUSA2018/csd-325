...
LC: Bonus Rule - If the dice total is 2 or 7, you receive a 10 mon bonus.
''')
...
while True:  # Main game loop.
    ...
    if diceTotal == 2 or diceTotal == 7:
        print('Your total roll was', diceTotal, '. You received a 10 mon bonus!')
        purse = purse + 10
